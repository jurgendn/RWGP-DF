...
class GlobalValues:
    ...
    EXPERIMENT_NAME = "[RIVF2025][sx-mathoverflow] Realworld Dataset"
...
class BatchSizeConfig:
    small_small = GraphParams(
        initial_fraction=BoundedValue("initial_fraction", 0.3, 0.6),
        delete_insertion_ratio=BoundedValue("delete_insertion_ratio", 0.6, 0.8),
        batch_range=[
            BoundedValue("small", 0.000001, 0.00001),
            BoundedValue("medium", 0.00001, 0.0001),
